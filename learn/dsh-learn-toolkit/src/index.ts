/**
 * @dsh-external/dsh-learn-toolkit — 工具包形态（由 dev_scaffold_plugin 生成）。
...
export const name = "@dsh-external/dsh-learn-toolkit"
...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.effect(() => ctx.tools.register(defineTool({
    name: '_dsh_external_dsh_learn_toolkit_hello',
    description: "学习用工具包：演示工具注册与 ctx.effect 资源管理",
    parameters: {
  ...
  })), '@dsh-external/dsh-learn-toolkit: hello tool')
  ...
  //   const MINE = new Set(['_dsh_external_dsh_learn_toolkit_hello'])
  //   const CORE = '<核心工具>'
