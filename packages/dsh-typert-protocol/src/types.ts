/**
 * Source-plane `./types` subpath of the vendored Typert protocol.
 *
 * `lib/` is the published build of the package — `lib/types/types.js` and `lib/types/types.d.ts` — and the real
